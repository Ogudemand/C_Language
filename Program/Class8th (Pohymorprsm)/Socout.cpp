#include <iostream>
#include "../Project1/Goliath.h"
#include "../Project1/Vulture.h"
#include "../Project1/SeigeTank.h"

using namespace std;

void Caluculator(char x, char y)
{
	cout << "char Function :" << (char)x + (char)y << endl;
}
