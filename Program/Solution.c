...
#pragma region 포인터
	...
	// 포인터가 기리키는 메모리 공간의 자료형은 알 수 없으므로
	...
	printf("data 변수의 값 : %d\n", data);
	printf("ptr 변수의 가리키는 값 : %d\n, *ptr");

	// 포인터 변수를 저장하기 위해 주소 값을 저장할 변수의 자료형과
	// 포인터 변수의 자료형이 일치해야 합니다.

	printf("pi 변수의 가리키는 값 : %f\n, pi");
	printf("ptr 변수의 가리키는 값 : %f\n, *ptr");
	*/
...
#pragma region sizeof 연산자
	// 피연산자의 크기를 바이트 단위로 반환하는 연산자 입니다.
