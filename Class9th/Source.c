...
void Swap(int* a, int* b)
{
	...
	*a = temp;
	...
	// 함수의 매개 변수에 변수의 복사된 갑이 전달되기 때문에
	// 인수로 전달한 변수 함수 내에서 일어난 연산에 대해'
	// 영향을 받지 않습니다.
...
#pragma region 매개 변수
	...
	// 함수의 경우 자료형과 반환하는 값의 형태가 일치하지 않으며
	// 원하는 값을 없을 수 없습니다.
...
#pragma region 재귀 함수
	...
	// 메모리가 계속 쌓이게 되므로 스택 오버플로우가 발생한다.
