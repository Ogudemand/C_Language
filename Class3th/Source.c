...
#pragma region 실수를 저장하는 방법
	...
	// 곱한 결과의 정수를 부분을 위에서 아래로 순서대로 정렬합니다.
...
#pragma region 조건문
	// 어떤 조건이 주어질 때 해당 조건에 따라 동장을
	// 수행하도록 실행하는 명령문입니다.

#pragma region 관계 연산자
	// 두개의 피연산자의 값을 비교하여 그 결과를 0
...
#pragma region switch문
	...
	//	// select문은 해당 조건이 완료되었을 때, break 문이 없으면
