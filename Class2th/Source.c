...
#pragma region 상수
	...
	//printf("pi의 값 : %f\n", pi);
	//
	//// "%f" : 실수(double)를 표현하는 서식 지정자
	//
	//
	//// 정수형 리터럴 상수는 저장하는 값의 범위가 크지 않으면
	//// int 자료형 으로 저장되며, 실수형 리터럴 상수는 double
	//// 자료형으로 저장됩니다.
	//
...
#pragma region 비트
	...
	// 1 byte 2 진수로 저장된 값을 2의 제곱으로 나타냅니다.
...
#pragma region 비트 연산자
	...
	// <OR 연산자>
	// 두 개의 피연산 중에 하나라도 1이 있다면 1을 반환하는 연산자 입니다.
	...
	// 첫 번쨰 비트는 부호를 타나내며, 첫 번째 비트에 1이 있다면 값은
	// 음수가 됩니다.
